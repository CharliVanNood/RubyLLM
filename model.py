...
def TrainModelNew():
    ...
    model.fit(train_x, train_y, batch_size=128, epochs=epochs_, validation_split=0.05, callbacks=[quickSave(model, tokenizer, sequenceLength), LearningRateScheduler(lr_schedule)])
